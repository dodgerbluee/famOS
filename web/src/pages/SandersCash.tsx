        ...
        {accounts.map((account) => {
          ...
          return (
            <button
              ...
              className="group bg-surface border-2 border-surface-lighter rounded-xl p-4 flex flex-col items-center gap-3 text-center transition-all duration-200 hover:border-primary hover:-translate-y-1 hover:shadow-lg active:scale-[0.98]"
            >
              {member?.avatarUrl ? (
